...
for biomarker in biomarkers:
    input_folder = Path(f"/work/users/m/c/mcgeet/DMETpaper/DMET-results/figures/mediation_proteinprotein/{biomarker}.pdf")
    output_folder = Path(f"/work/users/m/c/mcgeet/DMETpaper/DMET-results/figures/{biomarker}/jpgs/boxcox")
